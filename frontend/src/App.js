...
import QCWorkStation from './components/QCWorkStation/QCWorkStation';
...
function App() {
  return (
    <Router>
      <AuthProvider>
        <Routes>
          <Route path='/dashboard' element={<ProtectedRoute><PageTemplate><QCWorkStation/></PageTemplate></ProtectedRoute>}/> 
